    ...
    <Layout max>
      ...
      {date && (
        <div className='fixed inset-0 mt-10'>
          <div className='z-10 bg-gradient-to-t from-black to-transparent absolute inset-0 flex flex-col-reverse p-12 pb-32'>
            <div className='flex flex-col gap-2 text-white'>
              ...
              <p className='text-xs sm:text-sm md:text-2xl lg:text-base'>
                {date.explanation}
              </p>
            </div>
          </div>
